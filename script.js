...
recognition.onresult = function(event) {
 ...
 var toSpeak = new SpeechSynthesisUtterance(speak);
 ...
 para.innerHTML = "<b>You: </b><u class=\"you\">" + command + "</u>";
 document.querySelector(".history").appendChild(para);
 para.setAttribute("class", "command")
 var pra = document.createElement("p");
 pra.innerHTML = "<b>Me: </b><u class=\"me\">" + speak;
 pra.setAttribute("class", "speak")
 document.querySelector(".history").appendChild(pra);
 var his = document.querySelector(".history").innerHTML;
...
function s_down() {
 ...
 document.getElementById("setting_m").classList.toggle("setting_mn");
 document.querySelector(".hed_nav").classList.toggle("setting_bn");
}
function seth() {
...
function dress() {
 const myTimeout = setTimeout( drs_chg, 500);
 const mybtnTimeout = setTimeout( btn_chg, 2000 );
 document.getElementById("drs_opt").disabled = true;
 document.getElementById("curtain").classList.add("container");
 document.getElementById("dress").classList.add("dres");
 document.getElementById("chest1").classList.add('dres');
 document.getElementById("chest2").classList.add('dres' );
 setTimeout (() => {
  document.getElementById("curtain").classList.remove('container');
  document.getElementById("dress").classList.remove('dres');
  document.getElementById("chest1").classList.remove('dres');
    document.getElementById("chest2").classList.remove('dres');
 }, 1500 )
}
function drs_chg() {
 var drs =
...
function btn_chg() {
 document.getElementById("drs_opt").disabled = false;
}
let touchloc = [0, 0]
let touchd = false
...
document.body.addEventListener("touchstart", function(ev) {
  touchd = false;
  touchloc[0] = ev.touches[0].pageX;
  touchloc[1] = ev.touches[0].pageY;
 })
